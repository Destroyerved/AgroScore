    ...
    <div className="min-h-screen bg-accent-yellow">
        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <button className="bg-secondary text-white px-6 py-2 rounded-full font-semibold hover:bg-opacity-90">
                Get Started
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2">
              ...
              <button className="mt-8 bg-secondary text-white px-8 py-3 rounded-full font-semibold text-lg hover:bg-opacity-90 flex items-center">
                Start Assessment
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-6 text-center">
          ...
          <button className="bg-secondary text-white px-8 py-3 rounded-full font-semibold text-lg hover:bg-opacity-90">
            Get Started Now
          </button>
        </div>
      </section>
